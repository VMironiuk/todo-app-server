...
func (r *TodoListPostgres) Create(userId int, list todoappserver.TodoList) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoListPostgres) GetAll(userId int) ([]todoappserver.TodoList, error) {
	var lists []todoappserver.TodoList
...
func (r *TodoListPostgres) GetById(userId, listId int) (todoappserver.TodoList, error) {
	var list todoappserver.TodoList
...
func (r *TodoListPostgres) Update(userId, listId int, input todoappserver.UpdateListInput) error {
