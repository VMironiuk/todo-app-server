...
func (r *TodoItemPostgres) Create(listId int, item todoappserver.TodoItem) (int, error) {
	tx, err := r.db.Begin()
	if err != nil {
		return 0, err
	}
...
func (r *TodoItemPostgres) GetAll(userId, listId int) ([]todoappserver.TodoItem, error) {
	var items []todoappserver.TodoItem
...
func (r *TodoItemPostgres) GetById(userId, itemId int) (todoappserver.TodoItem, error) {
	var item todoappserver.TodoItem
...
func (r *TodoItemPostgres) Update(userId, itemId int, input todoappserver.UpdateItemInput) error {
